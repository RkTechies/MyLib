package com.beautybebo.libs.bbratings;
...
public class RatingReviews extends FrameLayout {
    ...
    public RatingReviews(Context mCtx2, AttributeSet attrs) {
        ...
        this.mBarDimension = a.getDimensionPixelSize(R.styleable.RatingReviews_width, (int) Utils.convertDpToPixel(20.0f, mCtx2));
        this.mBarColor = a.getColor(R.styleable.RatingReviews_color, Utils.DEFAULT_BAR_COLOR);
        this.mBarTextSize = (int) Utils.convertPixelsToDp((float) a.getDimensionPixelSize(R.styleable.RatingReviews_text_size, (int) Utils.convertDpToPixel(15.0f, mCtx2)), mCtx2);
        this.mBarTextColor = a.getColor(R.styleable.RatingReviews_text_color, Utils.DEFAULT_BAR_TEXT_COLOR);
        this.mBarMaxValue = a.getInt(R.styleable.RatingReviews_max_value, 0);
        this.mBarSpaces = a.getDimensionPixelSize(R.styleable.RatingReviews_spaces, (int) Utils.convertDpToPixel((float) Utils.DEFAULT_BAR_SPACE, mCtx2));
    ...
    private void draw(int dimension, Bar initialBar, final Bar bar, final View view) {
        ...
        if (this.isShowLabel) {
            ...
            view.findViewById(R.id.text_view_bar_label).setVisibility(View.GONE);
        }
        if (this.isShowRaters) {
            TextView raters = (TextView) view.findViewById(R.id.text_view_raters);
            if (bar.getStarLabel() != null) {
